...
public class UserResourceIntTest {
    ...
    public void setup() {
        ...
        UserResource userResource = new UserResource(userRepository, userService, mailService, userSearchRepository, myWxPayService);
