...
import { MessageContentDialogComponent } from '../../../../../../main/webapp/app/entities/message-content/message-content-dialog.component';
...
describe('Component Tests', () => {
    ...
    describe('MessageContent Management Dialog Component', () => {
        let comp: MessageContentDialogComponent;
        ...
        beforeEach(async(() => {
            ...
            .overrideTemplate(MessageContentDialogComponent, '')
            .compileComponents();
        }));
        ...
        describe('save', () => {
            it('Should call update service on save for existing entity',
                inject([],
                    fakeAsync(() => {
                        // GIVEN
                        const entity = new MessageContent(123);
                        spyOn(service, 'update').and.returnValue(Observable.of(new HttpResponse({body: entity})));
                        comp.messageContent = entity;
                        // WHEN
                        comp.save();
                        tick(); // simulate async
                        ...
                        expect(mockEventManager.broadcastSpy).toHaveBeenCalledWith({ name: 'messageContentListModification', content: 'OK'});
            ...
            it('Should call create service on save for new entity',
                inject([],
                    fakeAsync(() => {
                        // GIVEN
                        const entity = new MessageContent();
